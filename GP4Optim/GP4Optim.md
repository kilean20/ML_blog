...
For a test, 16 identical MLPs (Multi-Layer Perceptron) are randomly initialized and trained. The following compares the posterior estimate using GP (left) and NN ensemble (right):
